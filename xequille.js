...
const { ngazap } = require('./XEQUILLE/virtex/ngazap')
const { buttonkal } = require('./XEQUILLE/virtex/buttonkal')
const { cttl } = require('./XEQUILLE/virtex/cttl')
const { tizi } = require('./XEQUILLE/virtex/tizi')
const { weg } = require('./XEQUILLE/virtex/weg')
const { virtex7 } = require('./XEQUILLE/virtex/virtex7')
...
const thumbnail = fs.readFileSync ('./XEQUILLE/image/thumbnail.jpg')
const thumb = fs.readFileSync ('./XEQUILLE/image/thumbnail.jpg')
const myimage = fs.readFileSync ('./XEQUILLE/image/thumbnail.jpg')
const menuimg = fs.readFileSync ('./XEQUILLE/image/menu.jpg')
const menuimage = fs.readFileSync ('./XEQUILLE/image/menu.jpg')
...
const banned = JSON.parse(fs.readFileSync('./XEQUILLE/dbnye/banned.json'))
virgam = fs.readFileSync(`./XEQUILLE/image/deden.jpeg`)
//=================================================//
...
┣❏🐒【628xxxxx】
┣❏ꜱᴀɴᴛᴇᴛ【628xxxxx】
┣❏ꜱᴇɴᴅɢᴀꜱꜰᴜʟʟ【628xxxxx】
┣❏ꜱᴇɴᴅᴜɴʟɪᴛʀᴏʟɪ【628xxxxx】
┣❏ꜱᴇɴᴅᴜɴʟɪᴅᴏᴄᴜ【628xxxxx】
┣❏ꜱᴇɴᴅᴜɴʟɪᴄᴜʏ【628xxxxx】
┣❏ꜱᴇɴᴅᴜɴʟɪʙᴏᴍ【628xxxxx】
┣❏ꜱᴇɴᴅᴜɴʟɪʟᴀɢ【628xxxxx】
┣❏ꜱᴇɴᴅᴜɴʟɪᴅᴇʟᴀʏ【628xxxxx】
┗━━⊱
*❏•≫──≪•◦ 👥 ◦•≫──≪•❏*
┏━━⊱
┣❏ɢᴀꜱꜰᴜʟʟɢᴄ【ɪᴅ ɢʀᴏᴜᴘ】
...
case 'menu':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
let title2 = `Runtime : ┣📋: ${runtime(process.uptime())}
Jam : ${time}`
sendGeekzMessage(from, { 
text: `*❏•≫──≪•◦ ♾ ◦•≫──≪•❏*
┣🤖.Name Bot: ${botname}
...
case 'funmenu':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
let title1 = `Runtime : ┣📋: ${runtime(process.uptime())}
Jam : ${time}`
sendGeekzMessage(from, { 
text: `*❏•≫──≪•◦ ♾ ◦•≫──≪•❏*
┣🤖.Name Bot: ${botname}
...
if (!isCreator) return m.reply(`*khusus Premium*`)
await loading()
joauu = fs.readFileSync('./XEQUILLE/video/hwmods.mp4')
...
if (!isCreator) return m.reply(`*khusus Premium*`)
await loading()
joauuuuu = fs.readFileSync('./XEQUILLE/video/hwmods2.mp4')
...
if (!teks) return m.reply(`Cara Penggunaan ┣📋.qc teks`)
await loading()
const text = `${teks}`
...
case 'hw': { 
if (isBan) return m.reply('*Lu Di Ban Owner*')
joauuuuuuu = fs.readFileSync('./XEQUILLE/video/hwmods2.mp4')
